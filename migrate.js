exports.up = (pgm) => {
  pgm.createTable("api_keys", {
    ...
    createdAt: { default: "now()", notNull: true, type: "timestamp" },
  ...
  pgm.createTable("categorie_juridique", {
    code: { notNull: true, type: "varchar(4)" },
    id: {
      default: new PgLiteral("uuid_generate_v4()"),
      notNull: true,
      type: "uuid",
  ...
  pgm.createTable("etablissements", {
    ...
    siret: { notNull: true, type: "varchar(14)" },
  ...
  pgm.createTable("mailing_list", {
    ...
    hash: "varchar(60)",
    id: "id",
    subscription_date: { default: "now()", notNull: true, type: "timestamp" },
  });

  pgm.createTable("matomo_user_id", {
    createdAt: { default: "now()", notNull: true, type: "timestamp" },
    user_id: { notNull: true, type: "varchar(120)" },
  });

  pgm.createTable("naf", {
    code: { notNull: true, type: "varchar(6)" },
    id: "id",
  ...
  pgm.createTable("psi_siren", {
    ...
    salaries_annee_courante: "integer",
    salaries_annee_precedente: "integer",
    siren: { notNull: true, type: "varchar(20)" },
  });
